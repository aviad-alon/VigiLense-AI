                ...
                "properties": {
                    ...
                    "summary_findings": {
                        ...
                        "description": (
                            ...
                            "⚠️ ARTICLE-ANCHORING RULE (Broad Surveillance Mode): Your analysis must be grounded "
                            "in what the included articles actually reported — not in the KB classification alone. "
                            "Before writing 'No candidate unlabeled signals identified': "
                            "(1) enumerate every distinct AE documented across included articles; "
                            "(2) confirm each one's EXACT term appears in the returned label chunks — "
                            "semantic proximity does NOT count; "
                            "(3) any article-reported AE that lacks an exact label match IS a Candidate "
                            "Unlabeled Signal and must appear in Novel Signal Assessment with an [N] citation. "
                            "Writing 'no novel signals' when articles document AEs not explicitly named in "
                            "the label (e.g., sensorineural hearing loss, acute pancreatitis, QTc prolongation) "
