            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "summary_findings": {
                        "type": "string",
                        "description": (
                            "Three simple markdown sections. Use bullet points for individual items. "
                            "No long paragraphs. No article titles or author names.\n\n"
                            "⚠️ ARTICLE-ONLY RULE: Base the entire analysis exclusively on the retrieved "
                            "articles. Do not add information from outside the articles. Cite every finding "
                            "with [N].\n\n"
                            ...
                            "State the main direction clearly (e.g., 'Most studies show that Metformin reduces "
                            "cancer risk, though a few identify elevated risk in specific subgroups'). "
                            "If no articles were retrieved, write one sentence stating that and stop.\n\n"
                            "### Findings Breakdown\n"
                            "Two optional sub-bullets — include only those that apply:\n"
                            "- **Protective / risk-reducing findings:** AEs or outcomes where studies show "
                            "reduced risk or protective effect, with [N] citations.\n"
                            "- **Risk / adverse findings:** AEs or outcomes where studies show increased risk "
                            "or harm, with [N] citations.\n"
                            "Omit a sub-bullet entirely if no findings of that type exist.\n\n"
                            "### Bottom Line\n"
                            "One direct sentence: is there a net safety concern or not?\n"
                            "- Dominant finding is protective and no clear overall risk → no safety escalation needed.\n"
                            "- Genuine risk signal → state what is concerning and why.\n"
                            "- Mixed evidence → describe the split and note which element (if any) warrants follow-up.\n"
